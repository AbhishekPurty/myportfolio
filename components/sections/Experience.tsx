      ...
      <div className="w-full mt-10 flex flex-col md:flex-row gap-16">
        <ul className="md:w-32 flex flex-col">
          <li
            onClick={handleBtech}
            className={`${
              workBTECH ? "border-l-textGreen text-textGreen" : "border-l-hoverColor text-textDark"
          ...
          <li
            onClick={handleSHS}
            className={`${
              workSHS ? "border-l-textGreen text-textGreen" : "border-l-hoverColor text-textDark"
            } border-l-2  bg-transparent hover:bg-[#112240] py-3 text-sm cursor-pointer duration-300 px-8 font-medium`}
          >
          ...
          <li
            onClick={handleHS}
            className={`${
              workHS ? "border-l-textGreen text-textGreen" : "border-l-hoverColor text-textDark"
            } border-l-2  bg-transparent hover:bg-[#112240] py-3 text-sm cursor-pointer duration-300 px-8 font-medium`}
          >
            High School
          </li>
